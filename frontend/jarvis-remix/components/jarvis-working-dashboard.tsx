...
import { Brain, Cpu, Activity, HardDrive, Wifi, Battery, Zap, Settings, MessageSquare, Bell, Home } from 'lucide-react';
...
export function JarvisWorkingDashboard({ initialData, healthStatus }: { initialData?: any, healthStatus?: any }) {
  ...
  const sidebarItems = [
    ...
    { id: 'quantum', name: 'Quantum Core', icon: Brain },
    { id: 'neural', name: 'Neural Networks', icon: Cpu },
